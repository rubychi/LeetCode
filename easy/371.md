 ...
 * since bitwise operators are converted to signed 32-bit integers in two's complement format
 * @param {number} num1
 * @param {number} num2
 * @return {number}
 */
 ...
 * use string in two's complement calculation to bypass the bitwise limitaion
